...
void ParticleEmitter::update( ofVec3f position, string Type) {
...
//
void ParticleEmitter::spawn(float time, ofVec3f position, string Type) {

	Particle particle(position,Type);
